...
class Ball {
    ...
    move() {
        ...
        } else if (this.x==' 1380px')
           this.x -= 15;
           this.monOjectDom.style.right = `${this.x}px`;
        }
...
class Prog {
    ...
    run() {
        ...
        this.interval = setInterval(this.move.bind(this), 8000);
    }
...
const monBallon = new Ball(155, 150, 50, 50, 'red', 25);
const monBallon2 = new Ball(155, 350, 20, 20, 'blue', 10);
