...
class Snake {
    ...
    this.monOjectDom.style.height = `${this.x}px`;
    this.monOjectDom.style.top = '0px';
    this.monOjectDom.style.left = '10px';
...
const piste = new Snake(500,500,'red');
const snake = new Snake(100,100,'red');
