...
class Snake {
    ...
    this.monOjectDom.style.width = '150px';
    this.monOjectDom.style.height = '150px';
    this.monOjectDom.style.top = this.y;
    this.monOjectDom.style.left = this.x;
    this.monOjectDom.style.stroke = 'red';
    this.monOjectDom.style.fill = 'white';
    
    this maLigne1 = document.createElementNS("http://www.w3.org/2000/svg",'line');
