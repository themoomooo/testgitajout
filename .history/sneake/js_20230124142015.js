...
class Snake {
    ...
    /* this.monOjectDom.style = `x="0" y="0" width="500" height="500"`; */

    this.monOjectDom.style.width = '50px';
    this.monOjectDom.style.height = '50px';
    this.monOjectDom.style.top = this.x;
    this.monOjectDom.style.stroke = '50px';
