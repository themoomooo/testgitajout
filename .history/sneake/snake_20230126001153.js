...
class Snake {
    constructor(width, height, x, y, color,) {
        ...
        space.appendChild(this.food.getfood());
        var _this = this;
    ...
    delete(){
        if (this.x==this.food.getfood().x.animVal.value && this.y==this.food.getfood().y.animVal.value) {
            this.food.getfood().setAttribute('x',this.x) 
            console.log(this.food.getfood().setAttribute('x',this.x) );
            this.food.getfood().setAttribute('y',this.y)
        }
    }
...
surface.append(snake.getsvg(), snake.getmsg(),snake.delete());
