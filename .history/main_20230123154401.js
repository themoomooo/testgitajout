...
class Prog {
   ...
   run(balle){
    for (let i = 0; i < this.balles.length; i++) {
        zoneTerrain.append(monBallon.getOjectDom(), monBallon2.getOjectDom());
    }
...
const monBallon = new Ball(20,20,200,200,'green',100);
const monBallon2 = new Ball(2500,250,100,100,'black',50);
