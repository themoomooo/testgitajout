...
class Ball {
    ...
    move() {
       /*  if (this.x < 1170) {
        ...
        let largueur = (document.main.clientWidth)-25
        if (this.x.offsetLeft <= largueur){
            this.monOjectDom.style.left = (this.x.offsetLeft + 1) + "px";
    } else {
            this.monOjectDom.style.left = (ball.offsetLeft - 1) + "px";
    }
    }
}
