...
class Ball {
    ...
    setOjectDom() {
        ...
        this.monOjectDom.style = `position:absolute;background-color:${this.color};border-radius:50%;width:${this.radius * 2}px;height:${this.radius * 2}px;top:${this.position.y}px;left:${this.position.x}px`;
    }
    getOjectDom() {
...
class Prog {
    ...
    run() {
        ...
        /*  this.interval = setInterval(this.move.bind(this), 1000/150); */
    }
