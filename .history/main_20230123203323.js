...
class Ball {
    constructor(x, y, width, height, color, radius,terrain) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    move() {
        let widthballe = this.terrain.clientWidth
        console.log(widthballe);
       /*  if (this.x < 1170 ) {
            this.x += 15;
...
const monBallon = new Ball(0, 155, 50, 50, 'red', 25,terrain);
const monBallon2 = new Ball(0, 155, 20, 20, 'blue', 10,terrain);
