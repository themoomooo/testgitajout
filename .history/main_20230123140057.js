...
class Ball {
    ...
    setOjectDom(){
        ...
        this.monOjectDom.style = `position:relative ; top:${this.y}px ; left:${this.x}px; width:${this.width}px ; height:${this.height}px ; background:url(${this.color}); border-radius:${this.radius}px`;
    }
    getOjectDom(){
