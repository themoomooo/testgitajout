...
class Ball {
    ...
    setOjectDom() {
        ...
        this.monOjectDom.style = `position:ab;background-color:${this.color};border-radius:50%;width:${this.radius * 2}px;height:${this.radius * 2}px;top:${this.position.y}px;left:${this.position.x}px`;
    }
    getOjectDom() {
